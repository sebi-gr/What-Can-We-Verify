...
Aktueller lokaler Abgleich (23.09.2026): PR #2 und PR #3 sind in `main` integriert; lokales `main` und `origin/main` standen nach dem letzten Fetch auf Merge-Commit `737b08e`. `data/VUL4J-18/`, der vollständige Review-Lauf und `data/pov/VUL4J-18-001/` sind vorhanden und ignoriert. Letzter Python-Prüfstand vor PR #2: 14/15 Offline-Tests bestanden, ein Symlink-Test wegen fehlenden Windows-Privilegs ausdrücklich übersprungen. Der neueste Review ist vollständig; der Java-PoV ist differenziell reproduziert.
